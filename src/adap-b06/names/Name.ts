...
export interface Name extends Cloneable, Printable, Equality {
    ...
    assertCorrectComponent(index: number, component: string): void;
    assertCorrectLengthPost(l: number): void;
    assertCorrectIntermediateState(length: number, index: number, component: string): void;
