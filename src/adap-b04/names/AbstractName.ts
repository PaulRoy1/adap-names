...
export abstract class AbstractName implements Name {
    ...
    public concat(other: Name): void {
        ...
        for (let i: number = 0; i < other.getNoComponents(); i++) {
            ...
            let currIndex: number = preLength + i;
            this.assertCorrectIntermediateState(currIndex + 1, currIndex, other.getComponent(i));
        }
        this.assertCorrectLengthPost(preLength + other.getNoComponents(), old);
    }
    ...
    abstract assertCorrectLengthPost(l: number, old: Name): void;
    abstract assertCorrectComponent(index: number, component: string, old: Name): void;
    abstract revert(to: Name): void;
}